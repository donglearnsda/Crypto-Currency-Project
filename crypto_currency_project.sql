...
alter table dbo.fact_swap
add constraint fk_fact_swap_dim_wallet foreign key (wallet_address) references dim_wallets (wallet_address);
...
--drop table dim_countries, dim_date, dim_token, dim_wallets, fact_price, fact_swap
...
-------------------------------------------------Volume and Number of transaction by Day-------------------------------------------------
...
-------------------------------------------------Volume transaction by country-------------------------------------------------

SELECT
	COUNT(DISTINCT(txn_id)) AS count_transaction,
	SUM(volume) AS volume_transaction,
	dc.country_name
INTO volume_Numb_transaction_by_country
...
SELECT * FROM dbo.volume_Numb_transaction_by_country


-------------------------------------------------Number of transaction by coin_type-------------------------------------------------
...
SELECT * FROM [dbo].[trans_count_by_platform]volume_transaction_table